package com.classichu.doubanloadingview;
...
public class DouBanSmileLoadingView extends View {
    ...
    public DouBanSmileLoadingView(Context context) {
        this(context, null);
    }

    public DouBanSmileLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DouBanSmileLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.DouBanSmileLoadingView);
        mRaidus = ta.getDimension(R.styleable.DouBanSmileLoadingView_smileCircleRadius, mRaidus);
        mSmileCircleFrameHeight = ta.getDimensionPixelOffset(R.styleable.DouBanSmileLoadingView_smileCircleFrameHeight, mSmileCircleFrameHeight);
        mSmileColor = ta.getColor(R.styleable.DouBanSmileLoadingView_smileColor, mSmileColor);
        mSmileAutomatic = ta.getBoolean(R.styleable.DouBanSmileLoadingView_smileAutomatic, mSmileAutomatic);
        mSmileHoldRotateCount = ta.getInteger(R.styleable.DouBanSmileLoadingView_smileHoldRotateCount, mSmileHoldRotateCount);
        //fix
